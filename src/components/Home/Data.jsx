...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Artemov Volodymyr
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description"> I am a Full Stack Developer with one year of hands-on experience, initially focusing on Python backend development
